...
class ToolRegistry:
    ...
    def load_default_tools(self) -> None:
        """
        Load all 13 default MCP tools with their metadata.
        
        This method registers all tools from the MCP Process Server with complete
        metadata including domains, categories, risk levels, and prerequisites.
        
        Tool Categories:
        - Discovery (6): list_industries, list_processes, get_process, get_equipment_types,
                        get_equipment_schema, get_stream_schema
        - Validation (3): validate_process_inputs, validate_connections, validate_equipment_inputs
        - Simulation (2): simulate_process, simulate_equipment
        - Run Tools (2): get_run, compare_runs
        """
        ...
        self.register_tool(ToolMetadata(
            ...
            description="Get parameter schema and requirements for a specific equipment type",
            input_schema={
                "type": "object",
                "properties": {
                    "equipment_type": {
        ...
        self.register_tool(ToolMetadata(
            ...
            description="Validate process equipment connections and sequence",
            input_schema={
                "type": "object",
                "properties": {
                    "process_id": {
        ...
        # ========================================
        # Run Tools (2) - All Safe
        # ========================================
        
        self.register_tool(ToolMetadata(
            name="get_run",
            description="Retrieve results from a previous simulation run by run ID",
            input_schema={
                "type": "object",
                "properties": {
                    "calc_run_id": {
        ...
        self.register_tool(ToolMetadata(
            name="compare_runs",
            description="Compare results from two simulation runs side by side",
            input_schema={
                "type": "object",
                "properties": {
                    "run_id_a": {
